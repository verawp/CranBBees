...
```{r}
Exp<-cbind(stancran$sAg_Prop,stancran$sAg_MPS,stancran$sFor_Prop,stancran$sFor_Clumpy,stancran$sMdw_Prop,stancran$sMdw_IJI,stancran$sHyd_Prop,stancran$sHyd_TE,stancran$sL_SD,stancran$sL_Con,stancran$FlwR)
